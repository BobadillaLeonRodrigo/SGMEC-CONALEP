            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h1 mb-0 text-gray-800"><strong>Mantenimiento</strong></h1>
                    </div>
                        ...
                        <div class="col-xl-12 col-lg-6">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-dark"><strong><i class="bi bi-card-checklist"></i> Formulario de Registro de Mantenimiento</h6></strong>
                                </div>
                                    <?php
                                        ...
                                        include "Controllers/RegisterMantenimientoController.php";
                                    ?>
                                <!-- Card Body -->
                                <div class="card-body">
                                    <form method="POST">
                                        <div class="row py-1 mb-3">
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <label class="text-dark"><strong>¿Que Mantenimiento Existe?</strong></label>
                                                    <input class="form-control" name="tipo_mantenimiento" type="text" placeholder="Preventivo, Correctivo, Ambos" />
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <label class="text-dark"><strong>¿Descripción?</strong></label>
                                                    <input class="form-control" name="descripcion" type="text" placeholder="Actividad a realizar" />
                                                </div>
                                            </div>
                                        </div>
                                        <input class="btn btn-outline-success text-dark" type="submit" name="btnregistro" size="10" value="Registrar Mantenimiento">
                                    </form>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 mb-6">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-dark"><strong><i class="bi bi-table"></i> Tabla de Registros de Mantenimiento</h6></strong>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-striped">
                                            ...
                                            <tbody class="text-center">
                                                <?php
                                                include "Models/conexion.php";
                                                include "Controllers/DeletMantenimientoController.php";
                                                $sql = $conexion->query("SELECT * FROM mantenimiento");
                                                while ($datos = $sql->fetch_object()) { ?>
                                                    <tr>
                                                        <td><?= $datos->id_mantenimiento ?></td>
                                                        <td><?= $datos->tipo_mantenimiento ?></td>
                                                        <td><?= $datos->descripcion ?></td>
                                                        <td>
                                                            <a href="UpdateMantenimiento.php?id=<?= $datos->id_mantenimiento ?>" class="btn btn-small btn-success" style="color:black"><i class="bi bi-pencil-fill"></i></a>
                                                            <a href="Mantenimiento.php?id=<?= $datos->id_mantenimiento ?>" class="btn btn-small btn-danger" style="color:black"><i class="bi bi-trash"></i></a>
                                                        </td>
                                                    </tr>
                                                <?php }
                                                ?>
