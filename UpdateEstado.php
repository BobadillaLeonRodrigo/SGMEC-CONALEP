...
$id = $_GET["id"];
$sql = $conexion->query("SELECT * FROM estado WHERE id_estado=$id");
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h1 mb-0 text-gray-800"><strong>Actualizar Estados</strong></h1>
                    </div>
                        ...
                        <div class="col-xl-12 col-lg-6">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-dark"><strong><i class="bi bi-card-checklist"></i> Formulario de Modificación de Estados</h6></strong>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    <form method="POST">
                                        ...
                                        <?php
                                        include "Controllers/EditEstadoController.php";
                                            ...
                                            <div class="row py-1 mb-3">
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        ...
                                                        <input class="form-control" name="tipo_estado" value="<?= $datos->tipo_estado ?>" type="text" placeholder="Activo, Inactivo, Mantenimiento, Desmantelado"/>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <label class="text-dark"><strong>¿Observaciones?</strong></label>
                                                        <input class="form-control" name="observaciones" value="<?= $datos->observaciones ?>" type="text" placeholder="Detalles"/>
                                                    </div>
                                                </div>
                                            </div>
                                        <?php
                                        ...
                                        ?>
                                        <input class="btn btn-outline-success text-dark" type="submit" name="btnmodificar" size="10" value="Modificar Estados">
                                    </form>
                                </div>
                            </div>
                        </div>
