                                        ...
                                        <div class="row py-1 mb-3">
                                            <div class="col-md-4">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    ...
                                                    <input class="form-control" name="nombreu" type="text" placeholder="Ingrese su Nombre" />
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <label class="text-dark"><strong>¿Cuál es tu Apellido Paterno?</strong></label>
                                                    <input class="form-control" name="appu" type="text" placeholder="Ingrese su Primer Apellido" />
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <label class="text-dark"><strong>¿Cuál es tu Apellido Materno?</strong></label>
                                                    <input class="form-control" name="apmu" type="text" placeholder="Ingrese su Segundo Apellido" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    ...
                                                    <input class="form-control" name="emailu" type="email" placeholder="rromero@2023conalepmex.edu.mx" />
                                                </div>
                                            </div>
                        ...
                        <div class="col-lg-12 mb-6">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-dark"><strong><i class="bi bi-table"></i> Tabla de Registros</h6></strong>
                                </div>
                                <div class="card-body">
