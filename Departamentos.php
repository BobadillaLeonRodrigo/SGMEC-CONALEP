            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h1 mb-0 text-gray-800"><strong>Departamentos</strong></h1>
                    </div>
                        ...
                        <div class="col-xl-12 col-lg-6">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-dark"><strong><i class="bi bi-card-checklist"></i> Formulario de Registro Departamental</h6></strong>
                                </div>
                                    <?php
                                        ...
                                        include "Controllers/RegisterDepartamentosController.php";
                                    ?>
                                <!-- Card Body -->
                                <div class="card-body">
                                    <form method="POST">
                                        <div class="row py-1 mb-3">
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <label class="text-dark"><strong>¿Que Departamento Existen?</strong></label>
                                                    <input class="form-control" name="tipo_departamento" type="text" placeholder="Laboratorista, Encargado, etc." />
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <label class="text-dark"><strong>¿Descripción del Departamento?</strong></label>
                                                    <input class="form-control" name="descripcion" type="text" placeholder="Ni no aplica ingrese: NA" />
                                                </div>
                                            </div>
                                        </div>
                                        <input class="btn btn-outline-success text-dark" type="submit" name="btnregistro" size="10" value="Registrar Departamento">
                                    </form>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 mb-6">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-dark"><strong><i class="bi bi-table"></i> Tabla de Registros Departamental</h6></strong>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-striped">
                                            ...
                                            <tbody class="text-center">
                                                <?php
                                                include "Models/conexion.php";
                                                include "Controllers/DeletDepartamentosController.php";
                                                ...
                                                while ($datos = $sql->fetch_object()) { ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="UpdateDepartamentos.php?id=<?= $datos->id_departamento ?>" class="btn btn-small btn-success" style="color:black"><i class="bi bi-pencil-fill"></i></a>
                                                            <a href="Departamentos.php?id=<?= $datos->id_departamento ?>" class="btn btn-small btn-danger" style="color:black"><i class="bi bi-trash"></i></a>
                                                        </td>
                                                    </tr>
                                                <?php }
                                                ?>
