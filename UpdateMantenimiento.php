            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h1 mb-0 text-gray-800"><strong>Actualización Mantenimientos</strong></h1>
                    </div>
                        ...
                        <div class="col-xl-12 col-lg-6">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-dark"><strong><i class="bi bi-card-checklist"></i> Formulario de Modificación Mantenimiento</h6></strong>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    <form method="POST">
                                        ...
                                        <?php
                                        include "Controllers/EditMantenimientoController.php";
                                            ...
                                            <div class="row py-1 mb-3">
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        ...
                                                        <input class="form-control" name="tipo_mantenimiento" value="<?= $datos->tipo_mantenimiento ?>" type="text" placeholder="Laboratorista, Encargado, etc." />
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <label class="text-dark"><strong>¿Descripción del Departamento?</strong></label>
                                                        <input class="form-control" name="descripcion" value="<?= $datos->descripcion ?>" type="text" placeholder="Ni no aplica ingrese: NA" />
                                                    </div>
                                                </div>
                                            </div>
                                        <?php
                                        ...
                                        ?>
                                        <input class="btn btn-outline-success text-dark" type="submit" name="btnmodificar" size="10" value="Modificar Departamento">
                                    </form>
                                </div>
                            </div>
                        </div>
