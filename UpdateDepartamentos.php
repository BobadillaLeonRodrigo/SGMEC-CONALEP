            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h1 mb-0 text-gray-800"><strong>Actualizar Departamento</strong></h1>
                    </div>
                        ...
                        <div class="col-xl-12 col-lg-6">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-dark"><strong><i class="bi bi-card-checklist"></i> Formulario de Modificación Departamental</h6></strong>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    <form method="POST">
                                        ...
                                        <?php
                                        include "Controllers/EditDepartametosController.php";
                                            ...
                                            <div class="row py-1 mb-3">
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        ...
                                                        <input class="form-control" name="tipo_departamento" value="<?= $datos->tipo_departamento ?>" type="text" placeholder="Laboratorista, Encargado, etc." />
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
